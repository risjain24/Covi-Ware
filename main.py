...
class Data:
	def __init__(self):
		...
		result_total = [{'name':'Coronavirus Cases:','value':counter_list[0]}, {'name':'Deaths:','value':counter_list[1]}, {'name':'Recovered:','value':counter_list[2]}]
...
def main():
	...
	TOTAL_PATTERNS = {
					...
					re.compile("[\w\s]+ total [\w\s]+ recovered"): data.get_TotalRecovered,
					re.compile("[\w\s]+ total recovered"): data.get_TotalRecovered
					}
